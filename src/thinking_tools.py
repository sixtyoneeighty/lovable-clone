"""
Sequential Thinking MCP Server for MojoCode
...
thinking_mcp = FastMCP("mojocode-thinking-mcp")
...
def sequentialthinking(
    ...
    * Hypothesis verification
    ...
    # Add metadata about the thinking process
    response["metadata"] = {
        "thinking_stage": "revision" if is_revision else "progression",
        "completion_percentage": min(100, (thought_number / total_thoughts) * 100),
        "can_continue": next_thought_needed or needs_more_thoughts
    }
    
    return response

# Create the MCP server
thinking_server = MCPServer(
    thinking_mcp,
    name="mojocode-thinking",
    cpu=0.5,
    memory=512,
